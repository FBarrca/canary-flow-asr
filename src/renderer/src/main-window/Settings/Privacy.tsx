    ...
    >
      <div style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 24 }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <Row>
            <div>
              ...
              <p style={{ fontSize: 12, opacity: 0.6 }}>Encrypt transcriptions and audio files</p>
            </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          {[
            ['history', 'Clear Transcription History', 'Remove all saved transcriptions'],
            ['cache', 'Clear Audio Cache', 'Remove cached audio files (2.3 GB)'],
            ['export', 'Export All Data', 'Download all your transcriptions and settings']
          ].map(([key, label, desc]) => (
            <div
              key={key as string}
              style={{
